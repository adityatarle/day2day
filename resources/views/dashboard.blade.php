...
<div class="p-6 space-y-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
        ...
        <div class="relative flex items-center justify-between">
            <div class="space-y-3">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-lg font-medium">Manage your business with powerful insights</p>
                    </div>
                </div>
            ...
            <div class="hidden md:block">
                <div class="text-right space-y-2">
                    ...
                    <div class="w-24 h-1 bg-gradient-to-r from-blue-300 to-purple-300 rounded-full mt-3 ml-auto"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <!-- Total Revenue -->
        <div class="metric-card rounded-2xl p-8 group cursor-pointer slide-in-up delay-100 interactive-card">
            <div class="flex items-center justify-between">
                <div class="space-y-3">
                    ...
                    <div class="space-y-1">
                        <p class="text-sm text-gray-500">This Month: ₹{{ number_format($stats['monthly_revenue'] ?? 0, 2) }}</p>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="progress-bar rounded-full" style="width: 75%"></div>
                        </div>
                    </div>
                </div>
                <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center icon-bounce group-hover:glow-blue">
        ...
        <!-- Total Orders -->
        <div class="metric-card rounded-2xl p-8 group cursor-pointer slide-in-up delay-200 interactive-card">
            <div class="flex items-center justify-between">
                <div class="space-y-3">
                    <div class="flex items-center space-x-2">
                        <p class="text-sm font-semibold text-gray-600 uppercase tracking-wider">Total Orders</p>
                ...
                <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center icon-bounce group-hover:glow-green">
        ...
        <!-- Total Products -->
        <div class="metric-card rounded-2xl p-8 group cursor-pointer slide-in-up delay-300 interactive-card">
            <div class="flex items-center justify-between">
                <div class="space-y-3">
                    <div class="flex items-center space-x-2">
                        <p class="text-sm font-semibold text-gray-600 uppercase tracking-wider">Total Products</p>
                ...
                <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-violet-600 rounded-2xl flex items-center justify-center icon-bounce group-hover:glow-purple">
        ...
        <!-- Total Customers -->
        <div class="metric-card rounded-2xl p-8 group cursor-pointer slide-in-up delay-400 interactive-card">
            <div class="flex items-center justify-between">
                <div class="space-y-3">
                    <div class="flex items-center space-x-2">
                    ...
                    <p class="text-3xl font-bold text-gray-900 group-hover:text-orange-600 transition-colors">
                ...
                <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center icon-bounce group-hover:glow-orange">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Branches -->
        <div class="glass-card rounded-2xl p-6 group hover:shadow-modern-lg transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wider">Branches</p>
                    <p class="text-2xl font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">
                ...
                <div class="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center icon-bounce">
        ...
        <div class="glass-card rounded-2xl p-6 group hover:shadow-modern-lg transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wider">Vendors</p>
                    <p class="text-2xl font-bold text-gray-900 group-hover:text-teal-600 transition-colors">
                ...
                <div class="w-14 h-14 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-xl flex items-center justify-center icon-bounce">
        ...
        <div class="glass-card rounded-2xl p-6 group hover:shadow-modern-lg transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="space-y-2">
                    <p class="text-sm font-semibold text-gray-600 uppercase tracking-wider">Pending POs</p>
                    <p class="text-2xl font-bold text-gray-900 group-hover:text-amber-600 transition-colors">
                ...
                <div class="w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl flex items-center justify-center icon-bounce">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <!-- Recent Orders -->
        <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-modern-lg border border-gray-200/50 overflow-hidden">
            <div class="p-6 border-b border-gray-200/50 bg-gradient-to-r from-gray-50 to-blue-50">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('orders.index') }}" class="btn-modern bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:shadow-lg transition-all duration-300">

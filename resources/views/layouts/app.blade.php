            ...
            <div class="w-64 bg-white shadow-lg min-h-screen">
                <div class="p-4">
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('vendors.index') }}" class="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-gray-100 {{ request()->routeIs('vendors.*') ? 'bg-blue-100 text-blue-700' : '' }}">
                            <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
